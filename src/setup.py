...
setup(
    ...
    install_requires=[
        "canonicaljson==1.6.2",  # https://github.com/matrix-org/python-canonicaljson/blob/master/CHANGES.md
        ...
        "Django>=3.2,<4.2",  # https://docs.djangoproject.com/en/2.0/releases/
