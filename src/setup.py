...
setup(
    ...
    install_requires=[
        "canonicaljson==1.6.3",  # https://github.com/matrix-org/python-canonicaljson/blob/master/CHANGES.md
        "chardet>=4.0,<5.1",  # https://github.com/chardet/chardet/releases
        ...
        "django-select2>=7.7,<8.1",  # https://github.com/applegrew/django-select2/releases
