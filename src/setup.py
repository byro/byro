...
setup(
    ...
    install_requires=[
        ...
        "Django~=3.1",  # https://docs.djangoproject.com/en/2.0/releases/
        ...
        "django-extensions>=2.2,<4.0",  # https://github.com/django-extensions/django-extensions/blob/master/CHANGELOG.md
        ...
        "django-select2~=7.4",  # https://github.com/applegrew/django-select2/releases
        ...
        "python-dateutil",
        "python-magic==0.4.15",
        "pynacl~=1.4",  # https://github.com/pyca/pynacl/blob/master/CHANGELOG.rst
