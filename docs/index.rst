...
byro is a membership administration tool currently in use at shackspace. It is meant
for small and medium sized clubs/NGOs/associations of all kinds, with a focus on the DACH region.
byro is heavily plugin based to help fit it to different requirements in many situations and
countries.
...
- **[TODO] Administrator documentation** for those who deploy, update, and maintain byro instances.
